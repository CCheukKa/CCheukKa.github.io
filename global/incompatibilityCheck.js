...
function browserCheck() {
    //! Browser detector doesn't work!
    return;
    if (!isChrome) {
        showWarning({
            title: 'Incompatibility Warning!',
            body: `Browser detected: ${browser}\nThis website is developed and tested with Chrome.\nThere may be visual bugs when rendered by other browsers!\nYou have been warned!`,
